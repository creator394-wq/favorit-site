...
Сайт построен вокруг 6 слотов изображений. **Чтобы получить финальный
премиальный сайт, замените файлы в `public/assets/` по назначению — код менять
не нужно, если имена слотов сохранены.**
...
| `transport.jpg` | D01 Движение | Карточка «Транспорт» на главной + нижний транспортный визуал в разделе «Транспорт» | ≥1920×1080 |
| `transport-hero.jpg` | D02 Transport Hero | Хедер раздела «Транспорт» | ≥1920×1080 |
...
AI-ассетами Wave 1 (A01/B01/C01/D01/D02/E01). Источники:
...
- `transport-hero.jpg` — отдельный approved hero для раздела «Транспорт»
